...
import { resetPopupSessionBoostOnSite } from "./reset-popup-session-boost-on-site";

test("syncs the popup session boost bundle before sending RESET_SESSION_BOOST_ON_SITE", async () => {
  ...
  await resetPopupSessionBoostOnSite(context, 7);
